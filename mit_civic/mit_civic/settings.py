...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'citydigits',
        'HOST': '/Applications/djangostack-1.9.7-0/mysql/tmp/mysql.sock',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = '_c8%7f5&nc0ho-tond#363j=#hfg74brt=a96zqhes*k%$#h9g'
...
ROOT_URLCONF = 'mit_civic.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mit_civic.wsgi.application'
